	...
	return {
		...
		loadFPDialogData: function (src, controller, multiSelect, bInit) {
			...
			oSelectDialog.attachLiveChange(function (oEvt) {
				...
				var f2;
				if(fltrInfo.FilterPanelID == "Certificates_FP1" /* & fltrInfo.Fieldame == "CustomerID" */){
				    f2 = new sap.ui.model.Filter({
		    		path : fltrInfo.AddDisplayField , 
		    		operator : sap.ui.model.FilterOperator.Contains, 
		    		value1: sQuery,
		    		caseSensitive : false
		    	});}else{ f2 = new sap.ui.model.Filter(fltrInfo.AddDisplayField, sap.ui.model.FilterOperator.Contains, sQuery); }}
